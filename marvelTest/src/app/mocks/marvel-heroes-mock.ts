...
export const mockData: ResponseDataMarvel = {
    count: 1,
    limit: 1,
    offset: 0,
    total: 1559,
    results: [
        {
            ...
            urls: [
                { type: 'detail', url: 'http://marvel.com/comics/characters/1011334/3-d_ma…piRef&utm_source=84ef7685cd270344c71886585101d21d' },
                { type: 'wiki', url: 'http://marvel.com/universe/3-D_Man_(Chandler)?utm_…piRef&utm_source=84ef7685cd270344c71886585101d21d' },
                { type: 'comiclink', url: 'http://marvel.com/comics/characters/1011334/3-d_ma…piRef&utm_source=84ef7685cd270344c71886585101d21d' }
            ]
